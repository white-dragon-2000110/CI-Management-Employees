    ...
    <div class="col-md-3 mb-3">
        <div class="card text-center">
            <div class="card-body">
                ...
                <p class="card-text text-muted">Active Employees</p>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3 mb-3">
        <div class="card text-center">
            <div class="card-body">
                ...
                <p class="card-text text-muted">Alarm Events</p>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3 mb-3">
        <div class="card text-center">
            <div class="card-body">
                ...
                <p class="card-text text-muted">Support Tickets</p>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-2">
                        <a href="/employee_portal" class="btn btn-success w-100" target="_blank">
                            <i class="fas fa-user-circle me-2"></i>Employee Portal
                        </a>
                    </div>
                </div>
            </div>
...
<div class="row">
    <div class="col-md-6 mb-4">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0"><i class="fas fa-exclamation-triangle me-2"></i>Recent Alarms</h5>
            </div>
            <div class="card-body">
                <?php if (!empty($alarm_stats['by_severity'])): ?>
                    <?php foreach (array_slice($alarm_stats['by_severity'], 0, 5) as $alarm): ?>
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            ...
                            <span class="text-muted"><?php echo $alarm->count; ?> events</span>
                        </div>
                    <?php endforeach; ?>
                <?php else: ?>
                    <p class="text-muted mb-0">No recent alarms</p>
                <?php endif; ?>
            </div>
        </div>
    </div>
